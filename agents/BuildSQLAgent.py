...
class BuildSQLAgent(Agent, ABC):
    ...
    def build_sql(self,source_type,evidence, user_grouping, user_question,session_history,tables_schema,columns_schema, similar_sql, max_output_tokens=2048, temperature=0.4, top_p=1, top_k=32):
